...
| Quote is shown under the speaker who said it | **Fail** — ISSUE-001 |
| Deadline follows the date stated in the recording | **Fail** — ISSUE-002 |

## Issues opened

| ID | Severity | Summary |
| --- | --- | --- |
| [ISSUE-001](../issues/ISSUE-001-speaker-attribution.md) | High | Quotes attributed to the wrong speaker when turns are merged |
| [ISSUE-002](../issues/ISSUE-002-anchor-date-conflict.md) | High | Recording date field silently overrides the spoken date |
| [ISSUE-004](../issues/ISSUE-004-evidence-order.md) | Medium | Quotes out of time order, role not shown |
| [ISSUE-003](../issues/ISSUE-003-unresolved-deadline-label.md) | Low | "no date context" shown when a date is known |
...
| A quote can be a whole five-sentence utterance | Correct, but weak as evidence | Expected to shrink after ISSUE-001 splits merged turns |
...
said a quote or **which date source** won. Each fix for ISSUE-001 and ISSUE-002 adds that assertion, so
